...
public class MenuDeCadastro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_de_cadastro);
        ...
        documentReference.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException error) {
                if(documentSnapshot != null){
                    text01.setText(documentSnapshot.getString("empregador"));
                    text02.setText(documentSnapshot.getString("cnpjPinhatec"));
                    text03.setText(documentSnapshot.getString("dataAdmissao"));
                    text04.setText(documentSnapshot.getString("cargo"));
                    text05.setText(documentSnapshot.getString("departamento"));
                }
            }
        });
    }
